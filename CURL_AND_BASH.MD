...
| [homebrew](https://brew.sh/) | Package manager for MacOS | https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh | [Docs](https://docs.brew.sh/Installation) | Uses direct Github download | [Yes](https://wwws.nightwatchcybersecurity.com/2021/04/30/security-of-homebrew-bootstrap-process/)  |
